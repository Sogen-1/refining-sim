...
CHOKE_POINTS = {
    "磷脂酶制剂": {
        ...
        "current_status": "进口占比高",
        "import_price_per_kg": 6000,
        "domestic_price_per_kg": 3500,
    ...
    "碟式离心机": {
        ...
        "current_status": "大型机型进口占比高",
        "import_price_per_unit": 2800000,
        "domestic_price_per_unit": 1500000,
        "units_per_line": 3,
        "import_uptime_pct": 93,
        "domestic_uptime_pct": 90,
        "import_oil_loss_extra_pct": 0,
        "domestic_oil_loss_extra_pct": 0.15,
        "maintenance_import_per_year": 120000,
        "maintenance_domestic_per_year": 80000,
        "saving_desc": "",
    },
    "流程模拟软件": {
        "foreign_supplier": "进口流程模拟软件",
        "domestic_alternative": "国产流程模拟软件 (已通过国家级验收)",
        "current_status": "油脂行业以进口为主",
        "import_price_per_year": 350000,
        "domestic_price_per_year": 120000,
        "training_cost_import": 150000,
        "training_cost_domestic": 50000,
        "saving_desc": "",
    },
    "VE/甾醇回收工艺": {
    ...
    "OPO结构脂酶": {
        ...
        "current_status": "进口占比高",
        "import_price_per_kg": 35000,
        "domestic_price_per_kg": 18000,
